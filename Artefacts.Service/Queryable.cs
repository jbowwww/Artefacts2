...
{
	public class Queryable : Queryable<Artefact>
	{
		public Queryable(IServiceClient serviceClient, string collectionName)
			: base(serviceClient, collectionName) { }
	}
	
	public class Queryable<T> : IQueryProvider, IQueryable<T>
	{
		...
		public Queryable(IServiceClient client, string collectionName, Expression expression = null)
		{
			if (client == null)
		...
		{
			return new Queryable<TElement>(Client, CollectionName, expression);
		}
